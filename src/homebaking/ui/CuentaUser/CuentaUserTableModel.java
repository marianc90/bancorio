...
public class CuentaUserTableModel extends AbstractTableModel {
     ...
     */
    private String[] nombresColumnas = {"NUMERO", "TIPO", "SALDO"};
    /**
     * TIPOS DE CADA COLUMNA (EN EL MISMO ORDEN DE LOS ENCABEZADOS)
     */
    private Class[] tiposColumnas = {Integer.class, String.class, double.class};
     ...
     */
    public CuentaUserTableModel(List<Cuenta> contenidoInicial) {
