...
public class MovimientoTableModel extends AbstractTableModel {
    ...
    private static final int COLUMNA_TARJETA = 7;

    /**
     * NOMBRES DE LOS ENCABEZADOS
     */
    private String[] nombresColumnas = {"ID","FECHA","DESC.","MONTO","TIPO", "CTA ORIGEN", "CTA DEST.", "TARJ."};
    /**
     * TIPOS DE CADA COLUMNA (EN EL MISMO ORDEN DE LOS ENCABEZADOS)
     */
    private Class[] tiposColumnas = {Long.class, Date.class, String.class, double.class, String.class, Integer.class, Integer.class, Long.class};
     ...
     */
    public MovimientoTableModel(List<Movimiento> contenidoInicial) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex) {
            ...
            case COLUMNA_TARJETA:
                result = (m.getTarjeta() != null) ? m.getTarjeta().getNumero() : "";
                break;
            default:
                result = new String("");
        }
